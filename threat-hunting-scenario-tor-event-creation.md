...
DeviceProcessEvents
| where ProcessCommandLine contains "tor-browser-windows-x86_64-portable-15.0.4.exe  /S"
...
## Created By:
- **Author Name**: Karanbir Singh
- **Author Contact**: https://www.linkedin.com/in/karanbir-singh-66a649376
- **Date**: April 22, 2026
...
|-------------|-------------------------------|------------------|-------------------|
| 1.0         | Initial draft                  | `April 22, 2026`  | `Karanbir Singh`   
